...
public class MainAplikasiKasir {
    ...
    public static void main(String[] args) {
        ...
        String transaksi_lagi = "", pesan_lagi = "", makan_ditempat;
                    ...
                    do {
                        ...
                        do {
                            ...
                            if (jumlah_kuah > jumlah_ramen) {
                                System.out.println("[Error] Jumlah kuah melebihi jumlah ramen yang sudah dipesan");
                            } else {
                                break;
                            }
                        }
    ...
    public void generateDaftarMenu(){
        ...
        daftarMenu.tambahMenu(new Kuah("Kuah Oriental"));
    ...
    public double cekInputNumber(String label){
        try{
            ...
            System.out.println("[Error] Harap Masukan Angka");
